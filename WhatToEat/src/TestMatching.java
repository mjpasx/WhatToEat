...
public class TestMatching
{
    ...
    static final String[][][] SUNSET_GRILLE_MATCHES = {
    	{
    		{"fried goat cheese with honey", "Fried Goat Cheese Salad"}, {"chicken & Serrano ham croquetas", ""}, {"grilled octopus", ""}, {"beef short ribs", ""}, {"potato omelette with spinach & manchego", ""}, {"patatas bravas", ""}, {"tres leches", ""}
    	}, 
    	{
    	...
    	{
    		{"quesadillas", "Chicken Quesadilla"}, {"mac & cheese", "Mac ‘n Cheese"}
    	},
    	{
    		{"BBQ pork", ""}, {"beef briskey sandwich", ""}
    	},
    	{
    	...
    	{
    		{"potato salad", ""}, {"mac n cheese", "Mac ‘n Cheese"}, {"small BBQ plate", ""}
    	},
    	{
    	...
    	{
    		{"Eggs Benedict's", ""}, {"canadian bacon", ""}, {"turkey sandwich", "Turkey Sandwich"}, {"blackbean burger", ""}
    	},
    	{
    	...
    	{
    		{"pico and guac", ""}, {"brisket sandwich", ""}, {"tuna tacos", "Ahi Tuna Tacos"}
    	},
    	{
    		{}
    	}
    ...
    static final String[][][] WING_COMPANY_RESULTS = {
    	...
    	{
    		{"bacon-wrapped wings", ""}, {"fries", "Fresh Cut Fries"}, {"sweet potato fries", ""}
    	},
    	{
    		{"tuna sandwiches", ""}
    	},
    	...
    	{
    		{"wings", "Wings"}, {"fries", "Fresh Cut Fries"}, {"sweet potato fries", ""}, {"onion rings", "Beer Battered Onion Wings"}, {"vegetarian burger", ""}
    	},
    	{
    		{"wings", "Wings"}, {"fries", "Fresh Cut Fries"}
    	},
    	...
    	{
    		{"Spicy vegetarian Samosa", ""}, {"Wings", "Wings"}, {"Samosa", ""}
    	},
    	{
    		{"Wings", "Wings"}
    	},
    	{
    		{"The Wing Man", ""}, {"Fries", "Fresh Cut Fries"}, {"Veggies & Dip", ""}, {"Brownies", ""}, {"wings", "Wings"}, {"Burgers", ""}, {"pizza", ""}
    	},
    	{
    		{"Wings", "Wings"}
    	},
    ...
    {    	
		...
		for (int i = 0; i < TEST_RESTAURANTS.length; i ++)
    	{
    		...
    		for (int j = 0; j < reviews.size(); j ++)
    		{
    			...
    			for (int q = 0; q < perReview.size(); q ++)
    			{
    				System.out.println(perReview.get(q).mealName);
    			}
    			System.out.println("\n");
    		...
    		for (int j = 0; j < restaurant.size(); j ++)
    		{
    			...
    			for (int l = 0; l < restaurantItems.size(); l ++)
    			{
    				...
    				for (int k = 0; k < review.size(); k ++)
    				{
    					...
    					System.out.println("Menu item:" + menuItem + "\tRestaurant item: " + restaurantItem);
