...
public class TestMatching
{
    ...
    */
    ...
    static final String[][][] PASTA_POMODORO_MATCHES = {
    	...
    	{
    		{"tortellini soup", "Tortellini Soup"}, {"Cesar salad", "Caesar Salad"}
    	}, 
    	{
    		{}
    	},
    ...
    {    	
    	...
    	System.out.println(JaroSimilarity2("chicken", "CHICKEN DUMPLING", 0.8));
    	System.out.println(JaroSimilarity2("chicken", "CHICKEN PINEAPPLE", 0.8));
    	System.out.println(JaroSimilarity2("MARTHA", "MARHTA", 0.8));
    	System.out.println(JaroSimilarity2("DIXON", "DICKSONX", 0.8));
    	System.out.println(JaroSimilarity2("JELLYFISH", "SMELLYFISH", 0.8));
...
//    						System.out.println((JaccardSimilarity(tokens1, tokens2, 0.8)));
//    						System.out.println("\n\n");
//    						System.out.println(CorrectMatch2(reviewGroundTruth, menuItem, restaurantItem));
//    					}
//    					
...
//    	backend.CleanUp(scanners);
    ...
    public static boolean CorrectMatch2(String[][] reviewGroundTruth, String menuItem, String restaurantItem)
    {
    	String[] entry = new String[2];
    	for (int i = 0; i < reviewGroundTruth.length; i ++)
    	{
